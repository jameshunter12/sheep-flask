...
def initActivity():
  ...
  a1 = activity(name='Daves Hot Chicken', uid='a1', address = '1268 Auto Park Way, Escondido, CA 92029', coordinates = 'lat: 33.158350, lng: -117.032630', fun='8/10')
  a2 = activity(name='Raising Canes', uid='a2', address = '8223 Mira Mesa Blvd, San Diego, CA 92126', coordinates = 'lat: 32.912239, lng: -117.147217', fun='10/10')
  a3 = activity(name='Belmont Park', uid='a3', address = '3146 Mission Blvd, San Diego, CA 92109', coordinates = 'lat: 32.769939, lng: -117.251091', fun='7/10')
  a4 = activity(name='Potato Chip Rock', uid='a4', address = 'Ramona, CA 92065', coordinates = 'lat: 33.010290, lng: -116.947480', fun='6/10')
